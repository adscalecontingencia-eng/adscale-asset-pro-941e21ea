...
const jsonLd = {
  ...
  "@type": "WebPage",
  name: "Soluções para Estrutura de Meta Ads | AD Scale",
  description:
    "AD Scale: soluções consultivas para organização e estrutura de operações profissionais de Meta Ads.",
  url: "https://www.adscalecontingencia.com/solucoes-meta-ads",
};
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-border/50 bg-background/80 backdrop-blur-xl sticky top-0 z-40">
        <div className="container max-w-6xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
          <Link to="/solucoes-meta-ads" aria-label="AD Scale">
            <Logo size={24} />
          </Link>
          <nav className="hidden md:flex items-center gap-6 text-sm text-muted-foreground">
            <Link to="/solucoes-meta-ads" className="hover:text-foreground">Início</Link>
